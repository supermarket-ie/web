...
Preview deployments generate sign-in session links from the incoming hostname
only when it matches this project's constrained
`web-*-supermarket-ie.vercel.app` pattern, and return to preview Home.
Production magic links continue to use the configured public site URL. This
