  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-1">
        {/* Desktop sidebar */}
        {showNav && (
          <aside className="hidden md:flex flex-col flex-shrink-0 w-[220px] sticky top-[57px] self-start h-[calc(100vh-57px)]"
            style={{
          ...
          >
            ...
            <div className="px-3 pb-6 pt-2" style={{ borderTop: '1px solid var(--surface-container)' }}>
              <button onClick={signOut} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium hover:opacity-70 transition-opacity"
        ...
        {/* Main content */}
        <div className={`flex-1 min-w-0 flex flex-col ${showNav ? 'pb-20 md:pb-0' : ''}`}>
