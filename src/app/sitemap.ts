...
const MEAL_SLUGS = [
  'spaghetti-bolognese', 'chicken-stir-fry', 'vegetable-lasagne',
  'irish-stew', 'sausage-pasta', 'overnight-oats',
];
...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/meals`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.8 },
    ...MEAL_SLUGS.map(slug => ({
      url: `${BASE_URL}/meals/${slug}`,
