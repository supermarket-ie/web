  ...
  async execute(input, ctx) {
    ...
    if (target == null) {
      return {
        ...
        target: null,
        highest_spend_items: highestSpend,
        message: 'No weekly budget is stored for this household. Ask for a target or offer to remember one.',
      };
    }
    ...
    return {
      ...
      over_by: difference > 0 ? difference : 0,
      under_by: difference < 0 ? Math.abs(difference) : 0,
      highest_spend_items: highestSpend,
    };
  },
});
